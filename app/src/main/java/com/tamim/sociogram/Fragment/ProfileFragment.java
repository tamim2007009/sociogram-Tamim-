...
import com.tamim.sociogram.Adapter.FollowersAdapter;
import com.tamim.sociogram.Model.Follow;
import com.tamim.sociogram.Model.User;
import com.tamim.sociogram.R;
import com.tamim.sociogram.databinding.FragmentProfileBinding;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()){
                            ...
                            System.out.println("user "+user.getCoverPhoto());
                            Picasso.get()
